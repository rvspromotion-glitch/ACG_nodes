...
1. Open with `{{TRIGGER}}`, her hair and eyes, and the shot size (close-up, medium, full body).
2. Outfit family, in the bundle's fixed wording.
3. Pose: weight, hips, spine, where hands and legs are, what faces the camera (front, back, side).
4. Face: where her eyes look, the mouth state, whether the face is fully in frame, cropped or turned away.
